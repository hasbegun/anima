# Anima — AI Agent Integration Guide

How to wire your AI agent into Anima so it can authenticate, get tokens, and call protected APIs. Anima uses ThunderID as its underlying identity provider.
